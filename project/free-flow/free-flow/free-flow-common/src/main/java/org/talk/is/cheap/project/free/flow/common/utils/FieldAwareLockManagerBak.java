...
// */
//public class FieldAwareLockManagerBak<K> {
//
...
//     *
//     * 20260315：终极个屁，这个锁没法重入，问题在于unlock会remove，比如说：
//     * 1. 线程A执行lock并获得锁
//     * 2. 线程B执行lock并等待锁
//     * 3. 线程A再次执行lock
//     * 4. 线程A执行unlockAndRemove，锁没了
//     * 5. 线程C执行lock，他可以获取锁了！
//     * 但是发现没，线程B持有的锁被线程的unlockAndRemove整没了，因为线程A需要unlock两次才行！但是一次unlockAndRemove直接把锁扔了！
//     *
//     * @param key
//     */
//    public void lock(K key) {
...
//        final FieldAwareLockManagerBak<Integer> lockManager = new FieldAwareLockManagerBak<>();
