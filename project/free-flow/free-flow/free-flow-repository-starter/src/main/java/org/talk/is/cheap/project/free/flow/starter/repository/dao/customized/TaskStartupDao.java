...
* for example
* public List<TaskStartup> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
*/
@Repository
public class TaskStartupDao {

    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.TaskStartupDao";
