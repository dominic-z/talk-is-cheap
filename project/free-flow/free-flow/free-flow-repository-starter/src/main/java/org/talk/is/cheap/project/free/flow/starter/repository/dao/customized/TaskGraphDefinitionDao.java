...
* for example
* public List<TaskGraphDefinition> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
public class TaskGraphDefinitionDao {
    ...
    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.TaskGraphDefinitionDao";
