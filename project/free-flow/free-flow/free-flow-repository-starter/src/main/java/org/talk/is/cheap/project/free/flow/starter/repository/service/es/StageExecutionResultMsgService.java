...
@Service
@Slf4j
public class StageExecutionResultMsgService {

    private static final String INDEX_NAME = "stage_execution_result_msg";

    private static final String SEQ_NAME = "stage_execution_result_msg";
     ...
     */
    public String create(StageExecutionResultMsg stageExecutionResultMsg) throws IOException {
        IndexRequest<StageExecutionResultMsg> req =
                new IndexRequest.Builder<StageExecutionResultMsg>()
                        .opType(OpType.Create)
                        .index(INDEX_NAME)
                        .id(Long.toString(seqGeneratorUtil.getNextId(SEQ_NAME)))
                        .document(stageExecutionResultMsg)
                        .build();
