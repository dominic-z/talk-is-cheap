...
* for example
* public List<SeqGenerator> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
public class SeqGeneratorDao {
    ...
    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.SeqGeneratorDao";
