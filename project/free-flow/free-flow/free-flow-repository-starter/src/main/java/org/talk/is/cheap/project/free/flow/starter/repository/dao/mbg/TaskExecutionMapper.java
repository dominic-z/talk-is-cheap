...
public interface TaskExecutionMapper {
    ...
    List<TaskExecution> selectByExampleDeepPagingByIdSubQuery(TaskExecutionExample example);
     ...
     * @mbg.generated Tue Sep 23 20:58:59 CST 2025
     */
    int insertBatchSelective(@Param("records") Collection<TaskExecution> records, @Param("excludeColNames") HashSet<String> excludeColNames);
}