...
* for example
* public List<StageExecution> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
*/
@Repository
public class StageExecutionDao {

    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.StageExecutionDao";
