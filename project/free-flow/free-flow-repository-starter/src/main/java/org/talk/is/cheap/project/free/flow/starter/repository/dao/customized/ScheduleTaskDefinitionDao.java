...
* for example
* public List<ScheduleTaskDefinition> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
*/
@Repository
public class ScheduleTaskDefinitionDao {

    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.ScheduleTaskDefinitionDao";
