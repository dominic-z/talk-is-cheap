...
* for example
* public List<StageSourceTargetStartupRelation> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
*/
@Repository
public class StageSourceTargetStartupRelationDao {

    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.StageSourceTargetStartupRelationDao";
