...
* for example
* public List<TaskDefinition> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
public class TaskDefinitionDao {
    ...
    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.TaskDefinitionDao";
