...
* for example
* public List<TaskExecution> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
public class TaskExecutionDao {
    ...
    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.TaskExecutionDao";
