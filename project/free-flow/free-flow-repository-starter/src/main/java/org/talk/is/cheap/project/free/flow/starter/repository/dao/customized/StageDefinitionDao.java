...
* for example
* public List<StageDefinition> findByIds(Collection<Long> ids) {
*       if (ids.isEmpty()) {
...
public class StageDefinitionDao {
    ...
    private static final String TABLE = "org.talk.is.cheap.project.free.flow.starter.repository.dao.customized.StageDefinitionDao";
