...
import org.talk.is.cheap.project.free.flow.starter.worker.utils.YamlUtils;
...
public class CuratorConfig {
    ...
    public CuratorFramework starterCuratorZKClient(@Autowired ZKConfigProperties zkConfigProperties) {
        CuratorFramework curatorZKClient = CuratorFrameworkFactory.builder()
                ...
                // 权限认证
                .authorization(zkConfigProperties.getZookeeper().getScheme(), zkConfigProperties.getZookeeper().getZkAuthId().getBytes(StandardCharsets.UTF_8))
                    ...
                    public List<ACL> getDefaultAcl() {
                        ...
                        try {
                            return Arrays.asList(
                                    new ACL(ZooDefs.Perms.ALL, new Id("digest", DigestAuthenticationProvider.generateDigest(zkConfigProperties.getZookeeper().getZkAuthId()))),
