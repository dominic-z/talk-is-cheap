...
安装字体，vuetify本身没icon也没样式，但是在[图标字体](https://vuetifyjs.com/zh-Hans/features/icon-fonts/)提到了他默认兼容4个常见icon集，比如使用material design icon(简称mdi)
```shell
...
安装icon，mdi的icon可以通过https://pictogrammers.com/library/mdi/进行搜索
```shell
cnpm install @mdi/js
