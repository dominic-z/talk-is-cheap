package org.talk.is.cheap.hello.spring.boot3.spi.starter3.config;
 ...
 */
@Configuration
@ComponentScan(basePackageClasses = Starter3Service.class)
public class Spring3SPIStarter3Configuration {
