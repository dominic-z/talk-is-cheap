...
public class ProductOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3114839138208449731L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductOrder\",\"namespace\":\"onehour.kafka.example.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":\"long\"},{\"name\":\"product_id\",\"type\":\"long\"},{\"name\":\"user_id\",\"type\":\"long\"}]}");
